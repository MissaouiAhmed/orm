        ...
        <div class="container-fluid">
            <div >
                ...
                <div >
                            ...
                            <tbody>                               
                                ...
                                <%
                                    ...
                                    for (Adherent adherent : list3) {
                                        ...
                                        out.print ("<td><a href='../AdminAdherentManagement?operation=remove&reference="+adherent.getId()+"'>REMOVE</td>");
                                        out.print ("<td><a href='../AdminAdherentManagement?operation=update&reference="+adherent.getId()+"'>UPDATE</td>");
                    ...
                    <h2 class="sub-header">Liste des Employees </h2>
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>Prenom</th>
                                    <th></th><th></th>
                                    <th><a href="addEmpoyee.jsp"><img src="../css/img/add-user-16x16.png"/></a> </th>
                            ...
                            <tbody>                               
                                ...
                                <%
                                    List<Employee> employees = (List) request.getSession().getAttribute("employees");
                                    for (Employee employee : employees) {
                                        out.print("<tr class='success'>");
                                        out.print("<td></td>");

                                        out.print("<td>" + employee.getId() + "</td>");
                                        out.print("<td>" + employee.getNom() + "</td>");
                                        out.print("<td>" + employee.getPrenom()+ "</td>");
                                        out.print ("<td><a href='../AdminEmployeeManagement?operation=remove&reference="+employee.getId()+"'>REMOVE</td>");
                                     out.print ("<td><a href='../AdminEmployeeManagement?operation=update&reference="+employee.getId()+"'>UPDATE</td>");
