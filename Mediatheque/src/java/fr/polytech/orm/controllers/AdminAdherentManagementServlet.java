 ...
 * @author Missaoui
 */
@WebServlet(name = "AdminAdherentManagementServlet", urlPatterns = {"/AdminAdherentManagement"})
public class AdminAdherentManagementServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      if(operation.equals("update")){
        ...
        response.sendRedirect("admin/updateadherent.jsp");
