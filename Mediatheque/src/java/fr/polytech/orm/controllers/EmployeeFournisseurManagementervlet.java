 ...
 * @author Missaoui
 */
@WebServlet(name = "EmployeeFournisseurManagementervlet", urlPatterns = {"/EmployeeFournisseurManagement"})
public class EmployeeFournisseurManagementervlet extends FournisseurManagementervlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("employee/StockManagement.jsp");
