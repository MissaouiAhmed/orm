 ...
 * @author Missaoui
 */
@WebServlet(name = "EmployeeProductManagementServlet", urlPatterns = {"/EmployeeProductManagement"})
public class EmployeeProductManagementServlet extends ProductManagementServlet {
